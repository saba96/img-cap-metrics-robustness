...
def main():
    with open('../dataset/various_num_objects/one_tag_unique_clip_score.json') as f:
        one_tag_caps = json.load(f)

    with open('../dataset/various_num_objects/two_tags_unique_clip_score.json') as f:
        two_tags_caps = json.load(f)

    with open('../dataset/various_num_objects/three_tags_unique_clip_score.json') as f:
        three_tags_caps = json.load(f)

    with open('../dataset/various_num_objects/one_tag_shuffled_clip_score.json') as f:
        one_tag_shuffled = json.load(f)

    with open('../dataset/various_num_objects/two_tags_shuffled_clip_score.json') as f:
        two_tags_shuffled = json.load(f)

    with open('../dataset/various_num_objects/three_tags_shuffled_clip_score.json') as f:
    ...
    for id in one_tag_caps:
        all_scores.append(one_tag_caps[id]['CLIPScore'])
        all_scores.append(two_tags_caps[id]['CLIPScore'])
        all_scores.append(three_tags_caps[id]['CLIPScore'])
        all_scores.append(one_tag_shuffled[id]['CLIPScore'])
        all_scores.append(two_tags_shuffled[id]['CLIPScore'])
        all_scores.append(three_tags_shuffled[id]['CLIPScore'])
        one_tag_scores.append(one_tag_caps[id]['CLIPScore'])
        two_tags_scores.append(two_tags_caps[id]['CLIPScore'])
        three_tags_scores.append(three_tags_caps[id]['CLIPScore'])
        one_tag_shuffled_scores.append(one_tag_shuffled[id]['CLIPScore'])
        two_tags_shuffled_scores.append(two_tags_shuffled[id]['CLIPScore'])
        three_tags_shuffled_scores.append(three_tags_shuffled[id]['CLIPScore'])
