...
def main():
    with open('../dataset/different_fine_grained/vqa_caps_clip_score.json') as f:
        vqa_gt_caps = json.load(f)

    with open('../dataset/different_fine_grained/plausible_caps_clip_score.json') as f:
        plausible_caps = json.load(f)

    with open('../dataset/different_fine_grained/image_tag_caps_clip_score.json') as f:
        image_tag_caps = json.load(f)
    
    with open('../dataset/different_fine_grained/random_caps_clip_score.json') as f:
    ...
    for id  in vqa_gt_caps:
        gt.append(vqa_gt_caps[id]['CLIPScore'])
        plausible.append(plausible_caps[id]['CLIPScore'])
        image_tag.append(image_tag_caps[id]['CLIPScore'])
        random.append(random_caps[id]['CLIPScore'])
        print(vqa_gt_caps[id]['CLIPScore'], plausible_caps[id]['CLIPScore'], image_tag_caps[id]['CLIPScore'], random_caps[id]['CLIPScore'])
        score = (vqa_gt_caps[id]['CLIPScore'], plausible_caps[id]['CLIPScore'], image_tag_caps[id]['CLIPScore'], random_caps[id]['CLIPScore'])
